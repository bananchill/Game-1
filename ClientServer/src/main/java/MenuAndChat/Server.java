...
public abstract class Server implements SendBroadcast {
    public static List<Cli> connectionList = new ArrayList<>();
            ...
            while (true) {
                ...
                if (message != null) {
                    if (message.getType() == MessageType.TEXT) {
                        ...
                        SendBroadcast.sendBroadcastMessage(formattedMessage);
