...
public class CardMovemant : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        IsDraggable = defaultParent.GetComponent<Hand>().type == FieldType.SELF_HAND;
